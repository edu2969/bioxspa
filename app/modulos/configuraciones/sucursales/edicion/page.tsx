...
export default function Page() {
    ...
    const [newBodega, setNewBodega] = useState<any>(null);
    ...
    const onSubmitBodega = async (data: any) => {
        ...
        const updatedBodegas = bodegas.map((bodega: any) => 
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                <div className="flex my-6 space-x-4">
                    ...
                    <div className="w-6/12">
                        ...
                        <Autocomplete
                            apiKey={"AIzaSyDgVXN9Y56Dr8uNSzx_44nOU6m8u6CM_S8"}
                ...
                <div className="my-6">
                    <div className="flex justify-between items-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                setNewBodega({ nombre: '', operativa: false, direccion: null });
                    ...
                    {(bodegas.length > 0 || newBodega) && (
                        <table className="min-w-full mt-4 divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {bodegas.map((bodega: any, index: number) => (
