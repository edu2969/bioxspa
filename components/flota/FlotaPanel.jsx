        ...
        <main className="mt-12 h-[calc(100vh-64px)] overflow-y-auto">
            <div className="grid grid-cols-5 h-full gap-4 p-4">
                ...
                onClick={() => router.push(`/modulos/configuraciones/flota/${vehiculo._id}`)}>
                    <Image className="absolute top-0 left-0 ml-12 mt-6" src="/ui/camion.png" alt="camion" width={188} height={146} />
                    <Image className="absolute top-0 left-0 ml-12 mt-6" src="/ui/camion_front.png" alt="camion" width={188} height={146} />
                    <div className="absolute ml-2" style={{ transform: "translate(90px, 56px) skew(0deg, -20deg)" }}>
                        <div className="ml-5 text-slate-800">
                    ...
                    <div className="mt-40">
                        <div className="flex text-blue-600">
                            ...
                            <p className="text-sm orbitron ml-2 mt-0.5 pt-1">{vehiculo.marca.split(" ")[1]}</p>
                        </div>
