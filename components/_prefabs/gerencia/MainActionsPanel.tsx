...
export default function MainActionsPanel({ visible }: MainActionsPanelProps) {
	...
	return (
		<div className="w-full h-full bg-white rounded-md p-4 border border-gray-300">
			...
			<Link href="/pedidos/nuevo" className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
				<TbShoppingBagPlus size="1.5rem" className="mr-2" />
				NUEVA VENTA
			</Link>
			<Link href="/cobros" className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 mt-2">
