/**
 * BIOX - Componente de Login Migrado a Supabase
 * Mantiene el diseño original pero usa Supabase Auth
 */
...
export default function LoginFormMigrated() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (!result.success) {
        const errorMsg = result.error || "email/password incorrectos";
      ...
      setError((error as Error).message || "Error en el login");
      setIsLoggingIn(false);
    }
  };
