    ...
    return <div className="mt-6">
        <div className={`w-full ${clienteId != null && noCredit ? '' : 'opacity-20'}`}>
            <div className="flex justify-between items-center">
                ...
                >
                    {loadingPrecios ? <Loader texto="Cargando..." /> : hasRole([TIPO_CARGO.encargado, TIPO_CARGO.gerente, TIPO_CARGO.neo]) ? 'Nuevo producto' : 'Solicitar producto'}
                </button>
            </div>
            <div className="w-full flex items-center bg-gray-300 px-4 py-2 mt-2 rounded-t-md uppercase text-sm sm:text-xs">
                ...
                <div className={`${hasRole([TIPO_CARGO.encargado, TIPO_CARGO.gerente, TIPO_CARGO.neo]) ? 'w-3/12' : 'w-9/12'} pr-4`}>
