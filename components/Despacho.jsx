...
export default function Despacho({ session }) {
    ...
    const [linkedVehicle] = useState(false);
    ...
    return (
        <div className="w-full h-screen overflow-hidden">
            ...
            <div className={`${!vehiculoSeleccionado && "opacity-20"}`}>
                <Image
                    className="absolute top-12 left-0 ml-12"
                    src="/ui/camion.png"
                    alt="camion_atras"
                    width={355}
                    height={275}
            ...
            <div className="w-full absolute bottom-0 right-0 flex items-center justify-center">
                {!loading && !certificaOk && rutaDespacho && <div>
                    ...
                    <p className="text-xl font-bold text-gray-700 mb-4">INICIO DE DESPACHO</p>
                        <MdCleaningServices className="inline-block mr-2 mb-6" style={{ transform: "scaleX(4)" }} />
                        <div className="flex">
                            <input
                                onChange={() => linkVehiculo()}
                                type="checkbox"
                ...
                {!loading && certificaOk && rutaDespacho && rutaDespacho.ventas && (
                            ...
                            <div className="flex flex-col md:flex-row px-4 py-2">
                                <div className="w-full md:w-1/3">
                                    <div className="flex flex-wrap text-gray-700 text-sm">
                                        {resumenCarga.length && resumenCarga.map((item, idx) => (
                ...
                {loading && <div className="fixed w-full top-72 mt-16"><Loader texto="CARGANDO TUS PEDIDOS..."/></div>}
                {!loading && !rutaDespacho && (
                    <div className="w-full py-6 px-12 bg-white mx-auto mb-32">
