...
function NotificationsPanel({ visible, onClick }) {
    ...
    return (<div style={{
        ...
        <ul className="pl-2 overflow-y-auto" style={{ height: 'calc(100% - 56px)' }}>
            ...
            return (<li key={notification.id} className="p-2 rounded-lg shadow mb-2 flex items-start cursor-pointer hover:bg-gray-100">
                        <image_1.default width={24} height={24} src={`/profiles/${user.avatar}`} alt={user.name} className="w-10 h-10 rounded-full mr-2"/>                        
