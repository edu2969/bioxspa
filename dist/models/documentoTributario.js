...
const documentoTributarioSchema = new mongoose_1.Schema({
...
const DocumentoTributario = mongoose_1.models.DocumentoTributario || mongoose_1.default.model("DocumentoTributario", documentoTributarioSchema);
exports.default = DocumentoTributario;
